...
class AbsencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create absence" do
    assert_difference("Absence.count") do
      post absences_url, params: { absence: { absence_type_id: @absence.absence_type_id, description: @absence.description, end_time: @absence.end_time, name: @absence.name, start_time: @absence.start_time, user_id: @absence.user_id } }
    end
  ...
  test "should update absence" do
    patch absence_url(@absence), params: { absence: { absence_type_id: @absence.absence_type_id, description: @absence.description, end_time: @absence.end_time, name: @absence.name, start_time: @absence.start_time, user_id: @absence.user_id } }
